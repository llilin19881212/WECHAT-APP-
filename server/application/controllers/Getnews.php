...
$sql = " SELECT `title` FROM `news`limit 1";
...
$sql = " SELECT title FROM `news`limit 2";
mysqli_query($conn, "set id 'utf8'");
...
$sql = " SELECT title FROM `news`limit 3";
mysqli_query($conn, "set id 'utf8'");
$result = mysqli_query($conn, $sql);
...
$sql = " SELECT artnum FROM `news`limit 1";
mysqli_query($conn, "set id 'utf8'");
$result = mysqli_query($conn, $sql);
...
$sql = " SELECT artnum  FROM `news`limit 2";
mysqli_query($conn, "set id 'utf8'");
$result = mysqli_query($conn, $sql);
...
$sql = " SELECT artnum  FROM `news`limit 3";
mysqli_query($conn, "set id 'utf8'");
$result = mysqli_query($conn, $sql);
