...
class Newspage1 extends CI_Controller {
...
$sql = " SELECT `title` FROM `preview`limit $artnum";
...
$sql = " SELECT author FROM `preview`limit $artnum";
mysqli_query($conn, "set id 'utf8'");
...
$sql = " SELECT article FROM `preview`limit $artnum";
mysqli_query($conn, "set id 'utf8'");
$result = mysqli_query($conn, $sql);
...
$sql = " SELECT artnum FROM `preview`limit $artnum";
mysqli_query($conn, "set id 'utf8'");
$result = mysqli_query($conn, $sql);
...
$sql = " SELECT auid FROM `preview`limit $artnum";
mysqli_query($conn, "set id 'utf8'");
$result = mysqli_query($conn, $sql);
