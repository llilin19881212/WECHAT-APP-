...
class Getswiper extends CI_Controller {
...
$sql = " SELECT `title` FROM `swiper`limit 1";
...
$sql = " SELECT title FROM `swiper`limit 2";
mysqli_query($conn, "set id 'utf8'");
...
$sql = " SELECT title FROM `swiper`limit 3";
mysqli_query($conn, "set id 'utf8'");
$result = mysqli_query($conn, $sql);
...
$sql = " SELECT title FROM `swiper`limit 4";
mysqli_query($conn, "set id 'utf8'");
$result = mysqli_query($conn, $sql);
...
$sql = " SELECT title FROM `swiper`limit 5";
mysqli_query($conn, "set id 'utf8'");
$result = mysqli_query($conn, $sql);
...
$rs=array($title1,$title2,$title3,$title4,$title5);
